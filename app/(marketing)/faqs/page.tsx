    ...
    <>
      ...
      >
        <StyloireHero className="max-w-[44rem] gap-5">
          <StyloireEyebrow className="text-white/55">Support</StyloireEyebrow>
          <h1 className="font-serif text-[clamp(3.4rem,7vw,5.8rem)] font-semibold uppercase leading-none tracking-[-0.02em] text-white">
            FAQs
          </h1>
          <p className="font-sans text-[clamp(0.88rem,1.5vw,1rem)] font-light leading-relaxed text-white/70">
