  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Styloire auto generates subject lines in the standard industry format: Talent Name / Event / Brand Name. Every email goes out with the correct brand name already in the subject line. No manual editing required."
      },
      {
